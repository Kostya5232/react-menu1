...
export default function Graph3D() {
  ...
  const scene = [new Sphere(), new Sphere(3, 20, '#ffff00', -15, 12, -7)];
  ...
  return (
    <div className="canvas3DContain">
      <div className="canvas3D">
        <Graph3DUI
          showHidePoints={showHidePoints}
          showHideEdges={showHideEdges}
          showHidePolygons={showHidePolygons}
        />
        <canvas id="canvas3D"></canvas>
      </div>
      <div className="selectFigur" id="selectFigur" onChange={() => {
        //ParamsComponent.createElement()
      }}>
        <select id="figures">
