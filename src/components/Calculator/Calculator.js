    ...
    return (
        <div className='calc'>
            ...
            <div className="Polynomial">
                ...
                <div>
                    <button className="operand-poly" onClick={() => calcPoly('add')}>+</button>
                    <button className="operand-poly" onClick={() => calcPoly('sub')}>-</button>
                    <button className="operand-poly" onClick={() => calcPoly('mult')}>*</button>
                </div>
                <textarea ref={refPolyD} placeholder="Ответ"></textarea>
                <div>
                    <button className="operand-result" onClick={() => calcPoly('point')}>Point</button>
                </div>
            </div>
        </div>
    );
